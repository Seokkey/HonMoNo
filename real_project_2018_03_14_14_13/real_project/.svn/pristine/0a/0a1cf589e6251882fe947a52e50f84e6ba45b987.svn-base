...
<html>
	...
	<div id ="hak">
		...
		<form action="./estiBoardWrite?c_idx=${param.c_idx}&c_num=${param.c_num}" method="post" enctype="multipart/form-data" id="estiForm" >
		<table>
			<tr>
				<td><input type="text" readonly="readonly" name="em_brand" value="${boardName}"/><h1>견적 문의하기</h1></td>
			</tr>			
			<tr>
				<td>제품 분류 : 
			...
			<tr>
				<td>제목 : <input type="text" name="b_subject"/></td>
			</tr>
			<tr>
				<td>사진 첨부 : 
					<div>
			...
			<tr>
				<td>배송희망일 : <input type="date" name="em_date"/> </td><!-- <a href="#">달력 버튼이나 기능</a> -->				
			</tr>
			<tr>
				<td>배송지역 : 
					<select name="d_area">
		...
		<input type="button" value="등록" onclick="javascript:estiBoardWrite()">
