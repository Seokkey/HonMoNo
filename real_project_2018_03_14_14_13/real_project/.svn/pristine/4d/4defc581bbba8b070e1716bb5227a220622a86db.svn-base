...
<body>
	...
	<br/>
	<br/>
	<div class="w3-content w3-container w3-margin-top" id="hak">
		<div class="w3-container w3-card-4">
			...
			<div>
				<form id="memberJoinForm" action="./memberInsert?m_rating=1" method="post" >
					...
					<p>
						<label>비밀번호</label> 
						<input  id="mPass" name="m_pass" type="password" placeholder="영문 숫자를 조합해 8자리 이상으로 작성해주세요." required class="pass w3-input"  oninput="checkPwd()">
					...
					<p>
						...
						<input class="w3-input" type="text" id="sample6_postcode" name="m_address1" placeholder="우편번호" readonly="	" required>
