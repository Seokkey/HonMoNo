...
<html>
	...
	<script>
		...
		function makeMemberList(data){
			...
			if(data.mList3.length>0){//회원 리스트가 있을 때
				
				for(var i=0;i<data.mList3.length;i++){
					
					contents += "<tr id='rmv"+i+"'>";
					contents += "<td>"+data.mList3[i].rnum+"</td>";
					contents += "<td>"+data.mList3[i].m_id+"</td>";
					contents += "<td id='m_nick"+i+"'>"+data.mList3[i].m_nick+"</td>";
					contents += "<td>"+data.mList3[i].m_name+"</td>";
					contents += "<td>"+data.mList3[i].m_phone+"</td>";
					contents += "<td>"+data.mList3[i].m_address1+"</td>";
					contents += "<td>"+data.mList3[i].m_address2+"</td>";
					contents += "<td>"+data.mList3[i].m_address3+"</td>";
					contents += "<td>"+data.mList3[i].ms_ceoname+"</td>";
					contents += "<td>"+data.mList3[i].ms_phone+"</td>";
					contents += "<td>"+data.mList3[i].ms_conum+"</td>";
					contents += "<td>"+data.mList3[i].m_date+"</td>";
